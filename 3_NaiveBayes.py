...
dados = pd.read_csv('risco-credito.csv')
...
print(modelo.classes_)     # valores da classe 
print(modelo.class_count_) # quantos registros tem pra cada valor da classe
print(modelo.class_prior_) # pobabilidades apriori
